      ...
      <section className="flex flex-col md:flex-row items-center justify-center md:justify-start gap-8 px-4 md:px-12 py-12 text-center md:text-left">
        ...
        <div className="max-w-xl w-full md:w-2/3">
          ...
          <p className="text-base md:text-lg leading-relaxed">
            SINCE 2025, TECHSHACK HAS STRIVED TO DELIVER SUPERIOR TECH SOLUTIONS. BASED IN MERSEYSIDE, WE EXCEL IN LUXURY TECH CARE. OFFERING A RANGE OF SERVICES, FROM ASSESSMENTS TO SCREEN REPAIRS, BOOK WITH US TODAY FOR A TECH EXPERIENCE LIKE NO OTHER!
          </p>
        </div>
      </section>
